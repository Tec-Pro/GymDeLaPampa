            ...
            if (conn != null) {
                try {
                   conn = DriverManager.getConnection(urlcero, login, password);
                    ...
                    sentencia.setQueryTimeout(7);
                    boolean s=sentencia.execute(comsSQLborra);
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un error en la restauracion", "error", JOptionPane.ERROR_MESSAGE);
                }
            }
            restaurar();
