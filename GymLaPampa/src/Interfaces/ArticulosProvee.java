...
public class ArticulosProvee extends javax.swing.JDialog {
     ...
     */
    public ArticulosProvee(java.awt.Frame parent, boolean modal, Proveedor proveedor, ArticulosGUI articuloGui) {
        super(parent, modal);
        ...
        while (it.hasNext()) {
            ...
            row[1] = art.getString("codigo");
            row[2] = art.getString("articulo");
            row[3]= art.getString("precio");
            row[4] = art.getBigDecimal("precio_compra").setScale(2, RoundingMode.CEILING).toString();
            row[5]= art.getString("stock");
            row[6]= art.getString("descripcion");
    ...
    private void tablaArticulosClicked(java.awt.event.MouseEvent evt) {
        if (evt.getClickCount() == 2) {
            ...
            Articulo articulo = Articulo.findFirst("id = ?", tablaArticulos.getValueAt(tablaArticulos.getSelectedRow(), 0));
    ...
    private void initComponents() {
        ...
        tablaArticulos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Codigo", "Articulo", "precio venta", "Precio Compra", "stock", "Descripcion"
            }
        ) {
